...
cause_descriptions = {
    ...
    "CLRD": "CLRD stands for Chronic Lower Respiratory Disease. According to World Health Organization(WHO), Chronic respiratory diseases (CRDs) affect the airways and other structures of the lungs. Some of the most common are chronic obstructive pulmonary disease (COPD), asthma, occupational lung diseases and pulmonary hypertension. In addition to tobacco smoke, other risk factors include air pollution, occupational chemicals and dusts, and frequent lower respiratory infections during childhood. CRDs are not curable; however, various forms of treatment that help open the air passages and improve shortness of breath can help control symptoms and improve daily  life for people living with these conditions. For more information please visit https://www.who.int/health-topics/chronic-respiratory-diseases#tab=tab_1 .",
    "Diabetes": "Diabetes is a chronic (long-lasting) health condition that affects how your body turns food into energy. Your body breaks down most of the food you eat into sugar (glucose) and releases it into your bloodstream. When your blood sugar goes up, it signals your pancreas to release insulin. Insulin acts like a key to let the blood sugar into your body’s cells for use as energy. With diabetes, your body doesn’t make enough insulin or can’t use it as well as it should. When there isn’t enough insulin or cells stop responding to insulin, too much blood sugar stays in your bloodstream. Over time, that can cause serious health problems, such as heart disease, vision loss, and kidney disease. Should you be interested to learn more click https://www.cdc.gov/diabetes/basics/diabetes.html ",
    "Heart disease": "Heart disease is the leading cause of death in the United States. The term “heart disease” refers to several types of heart conditions. In the United States, the most common type of heart disease is coronary artery disease (CAD), which can lead to heart attack. You can greatly reduce your risk for heart disease through lifestyle changes and, in some cases, medicine. For more please read https://www.cdc.gov/heartdisease/ .",
    "Influenza and pneumonia": "According to American Lung Association, Influenza (flu) is a highly contagious viral infection that is one of the most severe illnesses of the winter season. Influenza is spread easily from person to person, usually when an infected person coughs or sneezes. Pneumonia is a serious infection or inflammation of the lungs.The air sacs fill with pus and other liquid, blocking oxygen from reaching the bloodstream. If there is too little oxygen in the blood, the body's cells cannot work properly, which can lead to death. For more information go to https://www.lung.org/lung-health-diseases/lung-disease-lookup/pneumonia .",
    "Suicide": "Suicide is the act of deliberately killing oneself. Risk factors for suicide include mental disorder, especially depression, and neurological disorders, cancer and HIV infection."+
            ...
            " The goal of suicide prevention is to reduce factors that increase risk and increase factors that promote resilience. For more information visit https://www.cdc.gov/suicide/ .",
    "Kidney disease": "Chronic kidney disease, also called chronic kidney failure, involves a gradual loss of kidney function. Your kidneys filter wastes and excess fluids from your blood, which are then removed in your urine. Advanced chronic kidney disease can cause dangerous levels of fluid, electrolytes and wastes to build up in your body.more information can be found at https://www.mayoclinic.org/diseases-conditions/chronic-kidney-disease/symptoms-causes/syc-20354521",
...
''')
    st.write("This app allows you to explore the age-adjusted death rates for various causes of death in the United States over the past two decades. The data is sourced from the CDCs Wide-ranging Online Data for Epidemiologic Research (WONDER) database, which provides access to a wide range of public health data.")
    st.write("Age-adjusted death rates for different geographic areas or population groups are comparable when they are adjusted to the same standard population.")
